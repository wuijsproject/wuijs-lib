...
```
wuijs-lib/                 Repository.
├── imgs/                  Images used in the documentation.
│   ├── icons/             Icons generated by the `/tools/svg-icon-maker.py` tool from the WUIIcon class.
│   └── logo/              Project logo and isotype in SVG and PNG format.
├── legacy/                Deprecated fonts with previous versions.
│   └── WUI/               Libreria WUI JS.
├── src/                   Fuentes principales de la última versión.
│   └── WUI/               Libreria WUI JS.
├── tools/                 Herramientas complementarias.
├── CHANGELOG.md           Archivo del registro de cambios [EN].
├── LEEME.md               Documentación general [ES].
├── LICENSE                Licencia.
├── README.md              Documentación general [EN].
└── REGISTRODECAMBIO.md    Archivo del registro de cambios [ES].
```
