...
| **Document version** | `0.6.2.20260508.0` |
...
| [legacy](legacy/)                         | Deprecated sources with previous versions. |
| [legacy/wui-js](legacy/wui-js/)           | WUI/JS Project directory. |
| [legacy/wui-js/main](legacy/wui-js/main/) | WUI/JS Main library (previous versions). |
