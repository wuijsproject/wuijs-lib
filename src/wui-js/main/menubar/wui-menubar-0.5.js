...
class WUIMenubar {
	...
	init() {
		...
		if (this.#htmlElement instanceof HTMLElement) {
			...
			if (this.#properties.compacted) {
				this.#htmlElement.classList.add("compacted");
			}
			this.#htmlElements.bar.className = "bar" + (this.#properties.hiddenPassiveBorder ? " hidden-passive-border" : "");
...
/*
HTML output:
<div class="wui-menubar [compacted]">
	<div class="bar">
		<div class="header">
			<div class="expander">
				<div class="icon"></div>
