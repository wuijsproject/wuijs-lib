...
class WUIDatepicker {
	...
	#loadHTML() {
		...
		this.#htmlElements.input = document.querySelector(sel + " > input[type='date']");
		this.#htmlElements.opener = document.querySelector(sel + " > .opener");
		this.#htmlElements.inputs = document.querySelector(sel + " > .inputs");
		this.#htmlElements.inputYear = document.querySelector(sel + " > .inputs > .year");
		this.#htmlElements.inputMonth = document.querySelector(sel + " > .inputs > .month");
		this.#htmlElements.inputDay = document.querySelector(sel + " > .inputs > .day");
		...
		this.#htmlElements.period = document.querySelector(sel + " > .box > .header > .period");
		this.#htmlElements.periodText = document.querySelector(sel + " > .box > .header > .period > .text");
		this.#htmlElements.periodIcon = document.querySelector(sel + " > .box > .header > .period > .icon");
		this.#htmlElements.prev = document.querySelector(sel + " > .box > .header > .prev");
		this.#htmlElements.next = document.querySelector(sel + " > .box > .header > .next");
		this.#htmlElements.months = document.querySelector(sel + " > .box > .months");
		this.#htmlElements.week = document.querySelector(sel + " > .box > .week");
		this.#htmlElements.days = document.querySelector(sel + " > .box > .days");
